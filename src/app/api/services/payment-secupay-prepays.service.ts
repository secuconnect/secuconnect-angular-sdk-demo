...
/**
 * A convenient way to create a transaction for advance
 * payment (prepaid). S. a. Payment Transactions.
 */
@Injectable({
  providedIn: 'root',
})
export class PaymentSecupayPrepaysService extends BaseService {
  constructor(
  ...
  assignExternalInvoicePdf$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayPrepaysService.AssignExternalInvoicePdfPath, 'post');
    if (params) {
  ...
  cancelPaymentTransactionById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayPrepaysService.CancelPaymentTransactionByIdPath, 'post');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  capturePaymentTransactionById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayPrepaysService.CapturePaymentTransactionByIdPath, 'post');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  updateBasketByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayPrepaysService.UpdateBasketByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  reverseAccrualByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayPrepaysService.ReverseAccrualByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  setShippingInformationByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayPrepaysService.SetShippingInformationByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  /**
   * Path part for operation paymentSecupayprepaysPaymentSecupayPrepaysGetById
   */
  static readonly PaymentSecupayprepaysPaymentSecupayPrepaysGetByIdPath = '/Payment/Secupayprepays/{paymentPrepayId}';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `paymentSecupayprepaysPaymentSecupayPrepaysGetById()` instead.
   *
   * This method doesn't expect any request body.
   */
  paymentSecupayprepaysPaymentSecupayPrepaysGetById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayPrepaysService.PaymentSecupayprepaysPaymentSecupayPrepaysGetByIdPath, 'get');
    if (params) {
   ...
   *
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `paymentSecupayprepaysPaymentSecupayPrepaysGetById$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  paymentSecupayprepaysPaymentSecupayPrepaysGetById(params: {
    ...
    return this.paymentSecupayprepaysPaymentSecupayPrepaysGetById$Response(params).pipe(
      map((r: StrictHttpResponse<SecupayTransactionProductModel>) => r.body as SecupayTransactionProductModel)
    );
  }

  /**
   * Path part for operation paymentSecupayprepaysPaymentSecupayprepaysPost
   */
  static readonly PaymentSecupayprepaysPaymentSecupayprepaysPostPath = '/Payment/Secupayprepays';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `paymentSecupayprepaysPaymentSecupayprepaysPost()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  paymentSecupayprepaysPaymentSecupayprepaysPost$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayPrepaysService.PaymentSecupayprepaysPaymentSecupayprepaysPostPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
   ...
   *
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `paymentSecupayprepaysPaymentSecupayprepaysPost$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  paymentSecupayprepaysPaymentSecupayprepaysPost(params?: {
    ...
    return this.paymentSecupayprepaysPaymentSecupayprepaysPost$Response(params).pipe(
      map((r: StrictHttpResponse<SecupayTransactionProductModel>) => r.body as SecupayTransactionProductModel)
    );
  }
