...
/**
 * A convenient way to create an invoice transaction. S. a.
 * Payment Transactions.
 */
@Injectable({
  providedIn: 'root',
})
export class PaymentSecupayInvoicesService extends BaseService {
  constructor(
  ...
  assignExternalInvoicePdf$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayInvoicesService.AssignExternalInvoicePdfPath, 'post');
    if (params) {
  ...
  cancelPaymentTransactionById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayInvoicesService.CancelPaymentTransactionByIdPath, 'post');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  capturePaymentTransactionById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayInvoicesService.CapturePaymentTransactionByIdPath, 'post');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  updateBasketByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayInvoicesService.UpdateBasketByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  reverseAccrualByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayInvoicesService.ReverseAccrualByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  setShippingInformationByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayInvoicesService.SetShippingInformationByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  /**
   * Path part for operation paymentSecupayinvoicesPaymentSecupayInvoicesGetById
   */
  static readonly PaymentSecupayinvoicesPaymentSecupayInvoicesGetByIdPath = '/Payment/Secupayinvoices/{paymentInvoiceId}';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `paymentSecupayinvoicesPaymentSecupayInvoicesGetById()` instead.
   *
   * This method doesn't expect any request body.
   */
  paymentSecupayinvoicesPaymentSecupayInvoicesGetById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayInvoicesService.PaymentSecupayinvoicesPaymentSecupayInvoicesGetByIdPath, 'get');
    if (params) {
      rb.path('paymentInvoiceId', params.paymentInvoiceId, {});
    }
   ...
   *
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `paymentSecupayinvoicesPaymentSecupayInvoicesGetById$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  paymentSecupayinvoicesPaymentSecupayInvoicesGetById(params: {
    ...
    return this.paymentSecupayinvoicesPaymentSecupayInvoicesGetById$Response(params).pipe(
      map((r: StrictHttpResponse<SecupayTransactionProductModel>) => r.body as SecupayTransactionProductModel)
    );
  }

  /**
   * Path part for operation paymentSecupayinvoicesPaymentSecupayinvoicesPost
   */
  static readonly PaymentSecupayinvoicesPaymentSecupayinvoicesPostPath = '/Payment/Secupayinvoices';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `paymentSecupayinvoicesPaymentSecupayinvoicesPost()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  paymentSecupayinvoicesPaymentSecupayinvoicesPost$Response(params?: {

    /**
     * Invoice payment transaction input properties
     */
    body?: SecupayTransactionProductDTO
  }): Observable<StrictHttpResponse<SecupayTransactionProductModel>> {

    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayInvoicesService.PaymentSecupayinvoicesPaymentSecupayinvoicesPostPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
   ...
   *
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `paymentSecupayinvoicesPaymentSecupayinvoicesPost$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  paymentSecupayinvoicesPaymentSecupayinvoicesPost(params?: {
    ...
    return this.paymentSecupayinvoicesPaymentSecupayinvoicesPost$Response(params).pipe(
      map((r: StrictHttpResponse<SecupayTransactionProductModel>) => r.body as SecupayTransactionProductModel)
    );
  }
