...
/**
 * A convenient way to create a credit card transaction. S. a.
 * Payment Transactions.
 */
@Injectable({
  providedIn: 'root',
})
export class PaymentSecupayCreditcardsService extends BaseService {
  constructor(
  ...
  assignExternalInvoicePdf$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayCreditcardsService.AssignExternalInvoicePdfPath, 'post');
    if (params) {
  ...
  cancelPaymentTransactionById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayCreditcardsService.CancelPaymentTransactionByIdPath, 'post');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  capturePaymentTransactionById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayCreditcardsService.CapturePaymentTransactionByIdPath, 'post');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  updateBasketByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayCreditcardsService.UpdateBasketByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  reverseAccrualByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayCreditcardsService.ReverseAccrualByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  setShippingInformationByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayCreditcardsService.SetShippingInformationByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  /**
   * Path part for operation paymentSecupaycreditcardsPaymentSecupayCreditcardsGetById
   */
  static readonly PaymentSecupaycreditcardsPaymentSecupayCreditcardsGetByIdPath = '/Payment/Secupaycreditcards/{paymentCreditCardsId}';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `paymentSecupaycreditcardsPaymentSecupayCreditcardsGetById()` instead.
   *
   * This method doesn't expect any request body.
   */
  paymentSecupaycreditcardsPaymentSecupayCreditcardsGetById$Response(params: {

    /**
     * Payment credit cards id
     */
    paymentCreditCardsId: string;
  }): Observable<StrictHttpResponse<SecupayTransactionProductModel>> {

    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayCreditcardsService.PaymentSecupaycreditcardsPaymentSecupayCreditcardsGetByIdPath, 'get');
    if (params) {
      rb.path('paymentCreditCardsId', params.paymentCreditCardsId, {});
    }
   ...
   *
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `paymentSecupaycreditcardsPaymentSecupayCreditcardsGetById$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  paymentSecupaycreditcardsPaymentSecupayCreditcardsGetById(params: {
    ...
    return this.paymentSecupaycreditcardsPaymentSecupayCreditcardsGetById$Response(params).pipe(
      map((r: StrictHttpResponse<SecupayTransactionProductModel>) => r.body as SecupayTransactionProductModel)
    );
  }

  /**
   * Path part for operation paymentSecupaycreditcardsPaymentSecupaycreditcardsPost
   */
  static readonly PaymentSecupaycreditcardsPaymentSecupaycreditcardsPostPath = '/Payment/Secupaycreditcards';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `paymentSecupaycreditcardsPaymentSecupaycreditcardsPost()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  paymentSecupaycreditcardsPaymentSecupaycreditcardsPost$Response(params?: {

    /**
     * Credit card payment transaction input properties
     */
    body?: SecupayTransactionProductDTO
  }): Observable<StrictHttpResponse<SecupayTransactionProductModel>> {

    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayCreditcardsService.PaymentSecupaycreditcardsPaymentSecupaycreditcardsPostPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
   ...
   *
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `paymentSecupaycreditcardsPaymentSecupaycreditcardsPost$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  paymentSecupaycreditcardsPaymentSecupaycreditcardsPost(params?: {
    ...
    return this.paymentSecupaycreditcardsPaymentSecupaycreditcardsPost$Response(params).pipe(
      map((r: StrictHttpResponse<SecupayTransactionProductModel>) => r.body as SecupayTransactionProductModel)
    );
  }
