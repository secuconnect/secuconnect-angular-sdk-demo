...
/**
 * A convenient way to create a SEPA direct dedit transaction.
 * S. a. Payment Transactions.
 */
@Injectable({
  providedIn: 'root',
})
export class PaymentSecupayDebitsService extends BaseService {
  constructor(
  ...
  assignExternalInvoicePdf$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayDebitsService.AssignExternalInvoicePdfPath, 'post');
    if (params) {
  ...
  cancelPaymentTransactionById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayDebitsService.CancelPaymentTransactionByIdPath, 'post');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  capturePaymentTransactionById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayDebitsService.CapturePaymentTransactionByIdPath, 'post');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  updateBasketByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayDebitsService.UpdateBasketByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  reverseAccrualByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayDebitsService.ReverseAccrualByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  setShippingInformationByPaymentId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayDebitsService.SetShippingInformationByPaymentIdPath, 'put');
    if (params) {
      rb.path('paymentMethod', params.paymentMethod, {});
      rb.path('paymentId', params.paymentId, {});
      rb.body(params.body, 'application/json');
  ...
  /**
   * Path part for operation paymentSecupaydebitsPaymentSecupayDebitsGetById
   */
  static readonly PaymentSecupaydebitsPaymentSecupayDebitsGetByIdPath = '/Payment/Secupaydebits/{paymentDebitId}';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `paymentSecupaydebitsPaymentSecupayDebitsGetById()` instead.
   *
   * This method doesn't expect any request body.
   */
  paymentSecupaydebitsPaymentSecupayDebitsGetById$Response(params: {

    /**
     * Payment debit id
     */
    paymentDebitId: string;
  }): Observable<StrictHttpResponse<SecupayTransactionProductModel>> {

    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayDebitsService.PaymentSecupaydebitsPaymentSecupayDebitsGetByIdPath, 'get');
    if (params) {
      rb.path('paymentDebitId', params.paymentDebitId, {});
    }
   ...
   *
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `paymentSecupaydebitsPaymentSecupayDebitsGetById$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  paymentSecupaydebitsPaymentSecupayDebitsGetById(params: {
    ...
    return this.paymentSecupaydebitsPaymentSecupayDebitsGetById$Response(params).pipe(
      map((r: StrictHttpResponse<SecupayTransactionProductModel>) => r.body as SecupayTransactionProductModel)
    );
  }

  /**
   * Path part for operation paymentSecupaydebitsPaymentSecupaydebitsPost
   */
  static readonly PaymentSecupaydebitsPaymentSecupaydebitsPostPath = '/Payment/Secupaydebits';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `paymentSecupaydebitsPaymentSecupaydebitsPost()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  paymentSecupaydebitsPaymentSecupaydebitsPost$Response(params?: {

    /**
     * Debit payment transaction input properties
     */
    body?: SecupayTransactionProductDTO
  }): Observable<StrictHttpResponse<SecupayTransactionProductModel>> {

    const rb = new RequestBuilder(this.rootUrl, PaymentSecupayDebitsService.PaymentSecupaydebitsPaymentSecupaydebitsPostPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
   ...
   *
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `paymentSecupaydebitsPaymentSecupaydebitsPost$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  paymentSecupaydebitsPaymentSecupaydebitsPost(params?: {
    ...
    return this.paymentSecupaydebitsPaymentSecupaydebitsPost$Response(params).pipe(
      map((r: StrictHttpResponse<SecupayTransactionProductModel>) => r.body as SecupayTransactionProductModel)
    );
  }
